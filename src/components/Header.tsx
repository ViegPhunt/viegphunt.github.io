...
export default function Header({ pathname }: { pathname: string }) {
    ...
    const navClasses = [
        'items-center', 'text-text', 'bg-background/90', 'backdrop-blur-xl', 'font-mono', 'shadow-none',
        // Mobile layout (base)
        'fixed', 'top-header', 'right-0', 'h-[calc(100dvh-theme(spacing.header))]', 'w-[min(18rem,82vw)]',
        ...
        // Desktop: desktop nav stays inside header
        'lg:hidden'
    ].join(' ');
